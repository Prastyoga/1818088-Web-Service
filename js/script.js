        ...
        .then(resJson => {
            ...
            resJson.teams.forEach(team => {
                ...
                <li class="collection-item avatar">
                    ...
                    <a href="#${team.id}" data-id="${team.id}" class="secondary-content"><i class="material-icons" data-id="${team.id}">info</i></a>
                </li>
                `
            });
...
function showTeamInfo(page){
    let url = baseUrl+ "teams/"+page;
    title.innerHTML = "Detail Tim Liga "
    ...
    <h2 class="header">Team Detail</h2>
    <div class="card horizontal">
      <div class="card-image">
      ...
      <div class="card-stacked">
        <div class="card-content">
          <p>
                Club : ${resJson.name} <br>
                Club Founded :  ${resJson.founded} <br>
                Club Colors :  ${resJson.clubColors} <br>
                Club Website : ${resJson.website} <br>
                Club Email : ${resJson.email} <br>
                Stadium Address : : ${resJson.address} <br>
          </p>
        </div>
      </div>
    </div>
